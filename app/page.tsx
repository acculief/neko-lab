...
export const metadata: Metadata = {
  ...
  description: '獣医師監修の猫フード・自動トイレ・猫砂・ペット保険をスコアで比較。2025年最新のおすすめランキング。キャットフード・猫おもちゃ・キャリーも網羅した猫特化メディア。',
  openGraph: {
    title: '猫用品おすすめランキング2025年版 | ねこラボ',
    description: '獣医師監修の猫フード・自動トイレ・猫砂・ペット保険をスコアで比較。2025年最新のおすすめランキング。',
